...
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/izzstores/singlev2/main/ssh/vps.conf"
...
[Unit]
Description=https://github.com/zhets
ProjectAfter=network.target

[Service]
WorkingDirectory=/root
ExecStart=/usr/local/sbin/limit.sh
Restart=always
...
systemctl restart tendang >/dev/null 2>&1
systemctl enable tendang >/dev/null 2>&1
systemctl restart tendang >/dev/null 2>&1
